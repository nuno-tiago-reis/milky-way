...
public class CameraController : MonoBehaviour {
	...
	public void FixedUpdate() {
		...
		Vector3 destination = this.spaceship.transform.position - this.spaceship.transform.forward * 15.0f + this.spaceship.transform.up * 7.5f;
		...
		this.transform.LookAt(this.spaceship.transform.position);
	}
}